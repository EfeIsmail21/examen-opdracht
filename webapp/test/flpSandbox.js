		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Materials",
									"targetURL": "#apmaterialslist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apmaterialslist-display": {
								"semanticObject": "apmaterialslist",
								"action": "display",
								"description": "ERP Applications",
								"title": "Materials",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.materialslist",
									"url": sap.ui.require.toUrl("ap/materialslist")
								}
							}
						}
					}
